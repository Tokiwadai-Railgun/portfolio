...
<SearchPage {title} on:search={onSearch}>
		<p>Au cours de ma formation en BTS SIO SLAM j'ai pu développer différentes compétences trouvables dans le fichier suivant : <a href={`${base}/files/tableau_competences.xlsx`}>Tableau_Competences.xlsx</a></p>
		{#if result.length === 0}
